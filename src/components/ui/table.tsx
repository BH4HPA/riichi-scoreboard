...
>(({ className, disableOverflow = false, ...props }, ref) => (
  <div className={disableOverflow ? "w-full" : "relative w-full overflow-auto"}>
    <table
      ref={ref}
...
>(({ className, disableBorderBottom = false, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(disableBorderBottom ? "" : "[&_tr]:border-b", className)}
    {...props}
  />
));
